...
<head>
    ...
    <style>
        ...
        td { padding: 8px; }
        .actions button {
            padding: 5px 8px; border: none; margin-right: 5px; cursor: pointer; border-radius: 4px;
        }
        .edit-btn { background: #3498db; color: white; }
        .delete-btn { background: #e74c3c; color: white; }
        .refund-btn { background: #f39c12; color: white; }
        .top-bar { display: flex; justify-content: space-between; align-items: center; }
        .alert { padding: 12px 15px; margin-top: 15px; border-radius: 6px; font-weight: 500; }
        .alert-success { background-color: #eafaf1; color: #2e7d32; border: 1px solid #c8e6c9; }
        .alert-error { background-color: #fdecea; color: #c62828; border: 1px solid #f5c6cb; }
        .alert i { margin-right: 8px; }
        .sidebar {
            width: 220px; background: #222; color: #fff; position: fixed; top: 0; left: 0; height: 100%;
            padding-top: 20px;
        }
        .sidebar h2 { text-align: center; color: #f1f1f1; }
        .sidebar ul { list-style: none; padding: 0; }
        .sidebar ul li { margin: 10px 0; }
        .sidebar ul li a {
            color: #fff; text-decoration: none; display: block; padding: 10px 15px; transition: background 0.3s;
        }
        .sidebar ul li a:hover, .sidebar ul li a.active { background: #3498db; }
        .add-btn { background: #28a745; color: white; padding: 8px 12px; border-radius: 4px; text-decoration: none; }
    </style>
</head>
<body>
